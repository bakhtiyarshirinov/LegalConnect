...
export function Sidebar() {
  ...
  return (
    <aside style={{
      ...
      padding: '16px 12px 80px', flexShrink: 0,
        ...
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              ...
              {badge && (
                <span style={{ background: '#EF4444', color: '#FFFFFF', borderRadius: '50%', fontSize: 10, fontWeight: 700, minWidth: 18, height: 18, display: 'inline-flex', alignItems: 'center', justifyContent: 'center', padding: '0 4px', lineHeight: 1 }}>
                  {badge}
                </span>
              )}
            </NavLink>
      ...
      {user && (
        <div style={{ position: 'absolute', bottom: 16, left: 12, right: 12, padding: '12px 14px', background: '#F5F5F5', borderRadius: 12, border: '1px solid #F0F0F0' }}>
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            <div style={{ width: 32, height: 32, borderRadius: '50%', background: '#0A0A0A', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 13, fontWeight: 700, color: '#FFFFFF', flexShrink: 0 }}>
            ...
            <div style={{ overflow: 'hidden', flex: 1 }}>
              ...
              <div style={{ fontSize: 10, color: '#6B6B6B', textTransform: 'uppercase', letterSpacing: '0.06em', fontWeight: 600, marginTop: 1 }}>{user.role}</div>
            </div>
          </div>
        </div>
      )}
