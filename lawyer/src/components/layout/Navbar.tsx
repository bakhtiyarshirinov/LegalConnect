...
export function Navbar() {
  ...
  return (
    <motion.header
      ...
      style={{
        height: 64, borderBottom: '1px solid #F0F0F0', background: '#FFFFFF',
    ...
    >
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        ...
        <div>
          <div style={{ fontSize: 14, fontWeight: 700, color: '#0A0A0A', letterSpacing: '-0.3px', lineHeight: 1 }}>LegalConnect</div>
          <div style={{ fontSize: 9, fontWeight: 600, color: '#A3A3A3', textTransform: 'uppercase', letterSpacing: '0.08em' }}>Pro</div>
        </div>
      </div>
